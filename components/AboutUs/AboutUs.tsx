    ...
    <section className={styles.container}>
      <div className={styles.content}>
        <div>
          ...
          <p>
            Coffee beans on the day. With the exception of the coffee beans that are in the container, only the cups of
            coffee beans and cups of other natural fruits that the chef uses to cook the food have special properties to
            them because that is all they cook for them.
          </p>
        ...
        <div>
          ...
          <p>
            ...
            creeping. Us don't cattle, bring. Waters she'd the isn't of without yielding beast lights gathered darkness
            night moved whales image i his. Give dry moveth moved moved, him doesn't. It beginning.
          </p>
          <a href="#" className={styles.button}>
            Read More <FaLongArrowAltRight className={styles.icon} />
          </a>
